...
import { addVaultItem, deleteVaultItem, editVaultItem, exportVault, getVaultItems, importVault, viewVaultHistory, viewVaultPassword, checkPasswordIntelligence } from '../controllers/vaultController';
...
vaultRoutes.post('/check-password', asyncHandler(checkPasswordIntelligence));
